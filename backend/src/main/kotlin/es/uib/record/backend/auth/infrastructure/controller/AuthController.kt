...
import es.uib.record.backend.auth.application.usecase.RevokeTokenUseCase
...
import es.uib.record.backend.model.LogoutRequest
...
class AuthController(
    ...
    override fun logout(logoutRequest: LogoutRequest): ResponseEntity<Unit> {
        this.revokeTokenUseCase.execute(logoutRequest.token)
